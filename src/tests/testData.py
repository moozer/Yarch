...
TestDirA_list = [   { 'md5': TestDirA_FileA_md5, 'filename': TestDirA_FileA, 'duplicates': [], 'directory': TestDirA },
...
TestDirB_list = [   { 'md5': TestDirB_FileA_md5, 'filename': TestDirB_FileA, 'duplicates': [], 'directory': TestDirB },
                    { 'md5': TestDirB_FileB_md5, 'filename': TestDirB_FileB, 'duplicates': [], 'directory': TestDirB },
                    { 'md5': TestDirB_SubdirA_FileA_md5, 'filename': TestDirB_SubdirA_FileA, 'duplicates': [], 'directory': TestDirB_subA },
                    { 'md5': TestDirB_SubdirA_FileB_md5, 'filename': TestDirB_SubdirA_FileB, 'duplicates': [], 'directory': TestDirB_subA }]
TestDirB_duppA_list = [   
                    { 'md5': TestDirB_FileA_md5, 'filename': TestDirB_FileA, 'duplicates': [0], 'directory': TestDirB },
                    { 'md5': TestDirB_FileB_md5, 'filename': TestDirB_FileB, 'duplicates': [1], 'directory': TestDirB },
                    { 'md5': TestDirB_SubdirA_FileA_md5, 'filename': TestDirB_SubdirA_FileA, 'duplicates': [0], 'directory': TestDirB_subA },
                    { 'md5': TestDirB_SubdirA_FileB_md5, 'filename': TestDirB_SubdirA_FileB, 'duplicates': [1], 'directory': TestDirB_subA }]
